...
export default interface TimeEntriesQuery extends Query {
  ...
  "in-progress"?: boolean;
  /**
   * If provided, filters results within the week before the datetime provided and only those entries with assigned project or task.
   * Datetime must be in ISO-8601 format (eg. 2020-01-01T00:00:00Z).
   */
